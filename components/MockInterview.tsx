...
const MockInterview: React.FC<MockInterviewProps> = ({ isOpen, onClose }) => {
  ...
  const generateQuestion = async () => {
    ...
    if (type === "Behavioral") {
      aiPrompt =
        "Generate a challenging behavioral interview question (e.g., STAR method based) for a software engineering candidate. Focus on leadership, conflict, or failure. Only return the question text.";
    } else if (type === "Technical") {
      aiPrompt =
        "Generate a conceptual technical interview question for a software engineer specializing in AIML or Data Science. Focus on fundamentals like 'The bias-variance tradeoff', 'Regularization techniques', or 'Gradient Descent internals'. Only return the question text.";
    } else {
      aiPrompt =
        "Generate a system design interview question for a scalable web application. Focus on components like 'Load balancing', 'Database sharding', or 'Caching strategies'. Only return the question text.";
    }
