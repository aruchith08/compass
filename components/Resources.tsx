    ...
    <div className="space-y-6">
       <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
          ...
          <p className="text-slate-400 text-sm mt-1">Curated list from the roadmap source.</p>
        </div>
        ...
        <div className="flex flex-col sm:flex-row gap-3 w-full md:w-auto">
          ...
          <div className="relative">
             ...
             <select
                ...
                className="w-full sm:w-40 bg-slate-900 border border-slate-800 text-slate-200 text-sm rounded-lg focus:outline-none focus:border-cyan-500 block pl-9 p-2.5 appearance-none cursor-pointer"
             >
                {categories.map(cat => (
          ...
          <div className="relative w-full md:w-64">
            ...
            <input 
              ...
              className="w-full bg-slate-900 border border-slate-800 text-slate-200 pl-10 pr-4 py-2 rounded-lg focus:outline-none focus:border-cyan-500 transition-colors"
            />
          </div>
        </div>
      </div>
          ...
          <table className="w-full text-left">
            <thead>
              <tr className="bg-slate-950 border-b border-slate-800">
                <th className="p-4 text-xs font-semibold text-slate-400 uppercase tracking-wider">Resource Name</th>
                <th className="p-4 text-xs font-semibold text-slate-400 uppercase tracking-wider">Category</th>
                <th className="p-4 text-xs font-semibold text-slate-400 uppercase tracking-wider">Related Task</th>
                ...
                <tr key={item.id} className="hover:bg-slate-800/50 transition-colors">
                  <td className="p-4">
                    <div className="flex items-center space-x-3">
                      ...
                      <span className="font-medium text-slate-200">{item.resource_name}</span>
                    </div>
                  </td>
                  <td className="p-4">
                  ...
                  <td className="p-4 text-right">
                    <a 
                      ...
                      className="inline-flex items-center justify-center p-2 text-cyan-400 hover:text-cyan-300 hover:bg-cyan-900/20 rounded-lg transition-colors"
                    >
